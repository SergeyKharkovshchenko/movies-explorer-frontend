...
// стейт по имени cart, в котором лежит itemsInCart = или cart это просто свойство глобального стейта (объекта) 
  name: 'cart',
  initialState: {
    itemsInCart: [],
  },
...
// идем по текущему стейту и удаляет ту игру (с пом айди игры) на которую мы нажали (передали в пейлоад)
